...
public class RawMaterialApiCotroller {
	...
	public @ResponseBody RawMaterialDetailsList getAllRawMaterialByGroup(@RequestParam("grpId") int grpId) {
		RawMaterialDetailsList rawMaterialDetails = new RawMaterialDetailsList();
		ErrorMessage errorMessage;
		List<RawMaterialDetails> rawMaterialDetailsList = rawMaterialDetailsRepository.findByGrpIdAndDelStatus(grpId,
				0);
	...
	public @ResponseBody RmRateVerification getRmRateVerification(@RequestParam("suppId") int suppId,
			@RequestParam("rmId") int rmId, @RequestParam("grpId") int grpId) {
	...
	public @ResponseBody List<RmRateVerificationList> getRmRateVerificationList(
			@RequestParam("suppId") List<String> suppId, @RequestParam("rmId") List<String> rmId) {
	...
	// Anmol---3-3-2020--
	@RequestMapping(value = { "/getRecipeListByItemAndType" }, method = RequestMethod.POST)
	public @ResponseBody ItemDetailList getRecipeListByItemAndType(@RequestParam("type") int type) {
		List<GetItemDetail> iDetails = getItemDetailRepository.getItemRecipeListByItemAndType(type);
