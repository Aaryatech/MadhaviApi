...
public class CustomerSaleReport {
	...
	public float getExtraCh() {
		return extraCh;
	}
	public void setExtraCh(float extraCh) {
		this.extraCh = extraCh;
	}
	@Override
	public String toString() {
		return "CustomerSaleReport [custId=" + custId + ", custName=" + custName + ", phoneNumber=" + phoneNumber
				+ ", whatsappNo=" + whatsappNo + ", emailId=" + emailId + ", profilePic=" + profilePic + ", gender="
				+ gender + ", custDob=" + custDob + ", ageGroup=" + ageGroup + ", langId=" + langId + ", cityId="
				+ cityId + ", compId=" + compId + ", frId=" + frId + ", isBuissHead=" + isBuissHead + ", companyName="
				...
				+ ", exFloat3=" + exFloat3 + ", exFloat4=" + exFloat4 + ", exFloat5=" + exFloat5 + ", payableAmt="
				+ payableAmt + ", discAmt=" + discAmt + ", wallet=" + wallet + ", extraCh=" + extraCh + "]";
	}
