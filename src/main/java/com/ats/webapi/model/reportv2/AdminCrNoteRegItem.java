...
@Entity
public class AdminCrNoteRegItem {
	...
	public String toString() {
		return "AdminCrNoteRegItem [crndId=" + crndId + ", hsnCode=" + hsnCode + ", crnId=" + crnId + ", crnDate="
				+ crnDate + ", invoiceNo=" + invoiceNo + ", billDate=" + billDate + ", frName=" + frName + ", frCode="
				+ frCode + ", frGstNo=" + frGstNo + ", crnQty=" + crnQty + ", crnTaxable=" + crnTaxable + ", cgstPer="
				+ cgstPer + ", sgstPer=" + sgstPer + ", igstPer=" + igstPer + ", cgstAmt=" + cgstAmt + ", sgstAmt="
				+ sgstAmt + ", igstAmt=" + igstAmt + ", crnAmt=" + crnAmt + ", billToName=" + billToName
				+ ", billToGst=" + billToGst + "]";
	}
