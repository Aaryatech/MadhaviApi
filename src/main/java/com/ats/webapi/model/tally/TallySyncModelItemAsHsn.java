...
@Entity
public class TallySyncModelItemAsHsn {
	...
	public String toString() {
		return "TallySyncModelItemAsHsn [billNo=" + billNo + ", date=" + date + ", eWayBillNo=" + eWayBillNo
				+ ", eWayBillDate=" + eWayBillDate + ", customerName=" + customerName + ", gstNo=" + gstNo
				...
				+ ", shipToState=" + shipToState + ", shipToStateCode=" + shipToStateCode + ", qty=" + qty + ", unit="
				+ unit + ", hsn=" + hsn + ", gstPer=" + gstPer + ", rate=" + rate + ", discount=" + discount
				+ ", amount=" + amount + ", cgst=" + cgst + ", sgst=" + sgst + ", igst=" + igst + ", otherLedger="
				+ otherLedger + ", roundOff=" + roundOff + ", totalAmount=" + totalAmount + "]";
	}
