...
public interface FranchiseForDispatchRepository extends JpaRepository<FranchiseForDispatch, Integer> {
	...
	@Query(value = " SELECT CONCAT(fr_name,' - ',fr_code) as fr_name,fr_id,  fr_route_id,fr_rate,fr_rate_cat FROM m_franchisee WHERE "
	...
	// Sumit
	@Query(value = " SELECT CONCAT(m_franchisee.fr_name,' - ',m_franchisee.fr_code) as fr_name,m_franchisee.fr_id,  m_franchisee.fr_route_id,m_franchisee.fr_rate,m_franchisee.fr_rate_cat FROM m_franchisee,m_franchise_sup,m_fr_route route WHERE "
...
//neha
	@Query(value = " SELECT CONCAT(m_franchisee.fr_name,' - ',m_franchisee.fr_code) as fr_name,m_franchisee.fr_id,  m_franchisee.fr_route_id,m_franchisee.fr_rate,m_franchisee.fr_rate_cat FROM m_franchisee,m_franchise_sup,m_fr_route route,m_franchise_sup sup  WHERE "
