...
List<GetRepFrDatewiseSellReport> getRepFrDatewiseSell(@Param("fromDate") String fromDate,@Param("toDate") String toDate, @Param("frId") List<String> frId);
	...
	@Query(value="SELECT\r\n" + 
			...
			"        m_franchisee\r\n" + 
			"    WHERE\r\n" + 
			"        t_sell_bill_header.bill_date BETWEEN :fromDate AND :toDate AND t_transaction_detail.sell_bill_no = t_sell_bill_header.sell_bill_no AND t_sell_bill_header.del_status = 0 AND t_sell_bill_header.fr_id IN(:frId) AND m_franchisee.fr_id = t_sell_bill_header.fr_id AND t_sell_bill_header.ext_int2>0 \r\n" + 
			"    GROUP BY\r\n" + 
			"        bill_date\r\n" + 
			"    ORDER BY\r\n" + 
			"        bill_date DESC\r\n" + 
			...
			"        t_sell_bill_header\r\n" + 
			"    WHERE\r\n" + 
			"        t_credit_note_pos.bill_no = t_sell_bill_header.sell_bill_no AND t_credit_note_pos.crn_date BETWEEN :fromDate AND :toDate AND t_credit_note_pos.del_status = 0 AND t_sell_bill_header.fr_id=:frId AND t_sell_bill_header.del_status = 0 AND t_sell_bill_header.ext_int2>0 \r\n" + 
			"    GROUP BY\r\n" + 
			"        t_credit_note_pos.crn_date ORDER BY t_credit_note_pos.crn_date DESC\r\n" + 
			") e\r\n" + 
			"ON\r\n" + 
			...
			"            order_date DESC) f \r\n" + 
			"  ON f.order_date=a.bill_date  ORDER BY bill_date",nativeQuery=true)
List<GetRepFrDatewiseSellReport> getDateWiseReportForOnline(@Param("fromDate") String fromDate,@Param("toDate") String toDate, @Param("frId") List<String> frId);
	...
	@Query(value="SELECT\r\n" + 
			...
			"            order_date DESC) f \r\n" + 
			"  ON f.order_date=a.bill_date  ORDER BY bill_date",nativeQuery=true)
List<GetRepFrDatewiseSellReport> getDateWiseReportForPOS(@Param("fromDate") String fromDate,@Param("toDate") String toDate, @Param("frId") List<String> frId);
