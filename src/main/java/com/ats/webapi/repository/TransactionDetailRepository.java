...
public interface TransactionDetailRepository extends JpaRepository<TransactionDetail, Serializable>{
	...
	@Query(value="SELECT\n" + 
			...
			"    t_transaction_detail.ex_var1,t_sell_bill_header.grand_total as ex_float1,t_sell_bill_header.remaining_amt  as ex_float2\n" + 
			"FROM\n" + 
	...
	@Query(value="SELECT\n" + 
			...
			"    t_transaction_detail.card_amt,\n" + 
			"    t_transaction_detail.e_pay_amt,\n" + 
			"    t_transaction_detail.e_pay_type,t_transaction_detail.disc_type,t_transaction_detail.del_status,t_transaction_detail.ex_int1,t_transaction_detail.ex_int2,t_sell_bill_header.invoice_no as ex_var2,\n" + 
			"    t_transaction_detail.ex_var1,t_transaction_detail.ex_float1,t_transaction_detail.ex_float2\n" + 
			"FROM\n" + 
			"    t_transaction_detail,\n" + 
			"    t_sell_bill_header\n" + 
			"WHERE\n" + 
			"    t_transaction_detail.del_status = 0  AND t_transaction_detail.transaction_date=:tdayDate AND t_transaction_detail.sell_bill_no = t_sell_bill_header.sell_bill_no  AND t_sell_bill_header.fr_id =:frId\n" + 
			"ORDER BY\n" + 
			"    t_sell_bill_header.sell_bill_no\n" + 
			"DESC\n" + 
			"LIMIT 50",nativeQuery=true)
