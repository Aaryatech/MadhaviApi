...
//Report 4  New work 
	...
	//catid!=3
			...
			@Query(value=" SELECT t_bill_detail.hsn_code as item_hsncd,m_item.id,m_item.item_tax1,m_item.item_tax2,m_item. item_tax3,m_item.item_name," + 
				...
				List<SalesReportItemwise> getSaleReportItemwise1O2(@Param("catId")int catId ,@Param("fromDate") String fromDate,@Param("toDate") String toDate,@Param("flag") int flag);
...
//other
			...
			@Query(value=" SELECT  t_bill_detail.hsn_code as item_hsncd,m_item.id,m_item.item_tax1,m_item.item_tax2,m_item. item_tax3,m_item.item_name," + 
				...
				List<SalesReportItemwise> getSaleReportItemwiseExceptTradingPacking1O2(@Param("fromDate") String fromDate,@Param("toDate") String toDate,@Param("flag") int flag);
			...
			@Query(value=" SELECT  t_bill_detail.hsn_code as item_hsncd,m_item.id,m_item.item_tax1,m_item.item_tax2,m_item. item_tax3,m_item.item_name," + 
					...
					" WHERE t_bill_header.bill_no=t_bill_detail.bill_no AND " + 
					"t_bill_detail.item_id=m_item.id AND t_bill_header.bill_date BETWEEN :fromDate AND :toDate AND t_bill_detail.cat_id!=5 and t_bill_header.del_status=0 and t_bill_detail.del_status=0 AND t_bill_header.ex_varchar2 IN(0,1) GROUP BY m_item.item_name order by m_item.item_grp1, m_item.item_grp2,m_item.item_name",nativeQuery=true)
				List<SalesReportItemwise> getSaleReportItemwiseExceptTradingPacking1N2(@Param("fromDate") String fromDate,@Param("toDate") String toDate);
