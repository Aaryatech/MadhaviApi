...
//Changes By harsha 
	...
	//spec fr changes 	
		...
		@Query(value="	SELECT\n" + 
				...
				"        m_category\n" + 
				"    WHERE\n" + 
				"        m_item.item_grp1 = m_category.cat_id AND m_category.cat_id IN(:catIdList) AND m_item.del_status = 0 AND m_item.is_stockable = 0 \n" + 
				"    GROUP BY\n" + 
				"        m_item.id\n" + 
				"    ORDER BY\n" + 
				"        m_item.item_grp1,\n" + 
				...
				"        d.item_id AS id,\n" + 
				"        SUM(d.qty) AS qty,\n" + 
				"        SUM(h.grand_total) AS bill_total\n" + 
				"    FROM\n" + 
