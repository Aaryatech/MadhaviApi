...
public class GetBillHeaderServiceImpl implements GetBillHeaderService {
	...
	@Override
	public GetBillHeaderList getBillHeader(List<String> frId, String fromDate, String toDate, int flag) {

		GetBillHeaderList getBillHeaderList = new GetBillHeaderList();

		List<GetBillHeader> billHeaders = getBillHeaderRepository.getBillHeader(frId, fromDate, toDate, flag);
	...
	@Override
	public GetBillHeaderList getBillHeaderForAllFr(String fromDate, String toDate, int flag) {

		GetBillHeaderList getBillHeaderList = new GetBillHeaderList();

		List<GetBillHeader> billHeaders = getBillHeaderRepository.getBillHeaderForAllFr(fromDate, toDate, flag);
		Info info = new Info();
